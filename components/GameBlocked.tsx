...
import ImageLoser from "../assets/loser.png";
import BackBtn from "../assets/BackBtn.png";
import NewGame from "../assets/NewPlayBtn.png";
import StreakLose from "../assets/streakLose.png";
...
export const GameBlocked = ({ block, back, newGame }: PropsBlock) => {
    ...
    <View style={styles.winner}>
      <View style={styles.text}>
        ...
        <View style={styles.win}>
          <Image source={StreakLose} style={styles.image} />
        </View>
